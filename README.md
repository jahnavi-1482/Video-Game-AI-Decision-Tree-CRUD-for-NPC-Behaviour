...
● Member 1: _jahnavi______________ 


● Member 2: _priyanka_________________
...
In modern video games, NPCs (Non-Player Characters) must make decisions based on 
different situations in the game environment.
...
CRUD operations (Create, Read, Update, Delete) to manage NPC behavior dynamically. 
...
Adds a new decision node to the tree. 
...
Modifies the decision stored in a node. 
...
Displays all nodes in the decision tree.
...
This project demonstrates how Decision Trees can be used to simulate NPC behavior in 
video games. 
